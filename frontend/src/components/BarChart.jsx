...
const PieChart = ({ profileId }) => {
  ...
  // First fetch the profile to determine if it's a parent/earner
  useEffect(() => {
    const fetchProfileAndExpenses = async () => {
      ...
      try {
        ...
        // Check if this is a parent based on the number of profiles returned
        // If more than one profile is returned, this is likely a parent
        ...
        // Now fetch the expense data based on whether they're a parent or not
